...
class OperatorContainer extends Component {
    ...
    handleSetSkip = (value) =>{
     ...
     handleSubmit = async (e) =>{
        e.preventDefault()
        const {lastNameValue, firstNameValue, loginValue, passwordValue} = this.state
        
        const data = { lastName: lastNameValue, 
                      firstName: firstNameValue,
                      login: loginValue, 
                      password: passwordValue }

        await axiosInter.post('/api/user/register', data)
          .then(res=>{
