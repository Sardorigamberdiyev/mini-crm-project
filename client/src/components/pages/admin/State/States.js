...
export default function States(props) {
  ...
  const {
      name, cost, nameValue, costValue,
      allStates, loading, uploadLoading, 
      statesMaxLength, skip, limit, onSkip,
  ...
  return <div className="state">
            ...
            <div className="state-element">
              {loading ? <Spiner /> : <><div className="state_all">
                  {allStates.map(item=><Element
                      key={item._id}
                      onDelete={onDelete}
                      id={item._id}
